---
title: Maintain your version of the file using GitHub
date: "2021-01-20T03:34:29.321Z"
template: "post"
draft: false
slug: "maintain-your-version-of-the-file-using-github"
category: "Version Control and Collaboration"
tags:
  - "Project Management"
  - "Version Control"
  - "Web Development"
description: "GitHub is a hosting platform for software development and version control which offers a distributed version control system and source code management(SCM). It offers open source through their code repos, which means they're publicly accessible—anyone can see, modify, and distribute the code as they see fit."
---
...
![hello-world.jpg](/media/hello-world.jpg)

To honor Dennis Ritchie, let us start with the "Hello, World!" project. Before that, There is a misconception that GitHub is just a repository, But it's definitely not. It's much more than that. Here, our focus would be to get comfortable making changes to our codebase, opening up a pull request(PR), and merging code into the main branch.
